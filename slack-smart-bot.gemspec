Gem::Specification.new do |s|
  ...
  s.files       = Dir["lib/slack/smart-bot/**/*.rb"] + ["lib/slack-smart-bot.rb","lib/slack-smart-bot_rules.rb", "LICENSE","README.md",".yardopts"]
  s.extra_rdoc_files = ["LICENSE","README.md"]
  s.homepage    = 'https://github.com/MarioRuiz/slack-smart-bot'
  s.license       = 'MIT'
  s.add_runtime_dependency 'slack-ruby-client', '~> 0.14', '>= 0.14.4'
  s.add_runtime_dependency 'nice_http', '~> 1.7', '>= 1.7.21'
