  ...
  describe "see teams" do
    ...
    describe "on external channel" do
      ...
      it "displays the teams, members, channels and info when calling see teams" do
        ...
        expect(buffer(to: channel, from: :ubot).join).to match(/_`unassigned`_:  Mario Ruiz Sánchez  \/  peter/i)
      ...
      it "displays the teams, members, channels and info when calling team NAME" do
        ...
        expect(buffer(to: channel, from: :ubot).join).to match(/_`unassigned`_:    :palm_tree: Mario Ruiz Sánchez,   :white_circle: peter/i)
