...
RSpec.describe SlackSmartBot, "poster" do
  describe "poster" do
    describe "on external channel" do
      uno = ':white_square::white_square::white_square::white_square:
      :white_square::white_square::black_square::white_square:
      :white_square::black_square::black_square::white_square:
      :white_square::white_square::black_square::white_square:
      :white_square::white_square::black_square::white_square:
      :white_square::white_square::black_square::white_square:
      :white_square::white_square::white_square::white_square:'.gsub(' ','')
      channel = :cexternal
      ...
      it "poster :EMOTICON_TEXT: :EMOTICON_BACKGROUND: MESSAGE" do
        ...
        expect(buffer(to: channel, from: :ubot).join.gsub(' ','')).to eq(uno.gsub(':black_square:',':lol:').gsub(':white_square:',':look:'))
      end
