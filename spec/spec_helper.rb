require "coveralls"
Coveralls.wear!
require "./spec/bot/environment.rb" if File.exist?("./spec/bot/environment.rb")
...
RSpec.configure do |config|
  ...
  config.after(:suite) do
    unless ENV["RUNNING"] == "true"
      if File.exist?("./spec/bot/buffer.log")
